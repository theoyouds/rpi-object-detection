...
while True:
    ...
    cv2.rectangle(
        frame, (top_left_x, top_left_y), (bottom_right_x, bottom_right_y), 255, 3
    )
    ...
    cv2.putText(
        frame, output_string, (50, 450), cv2.FONT_HERSHEY_COMPLEX, 1, (250, 0, 0), 2
    )
    ...
    if matches > threshold:
        ...
        cv2.putText(
            frame, "Object Found", (50, 50), cv2.FONT_HERSHEY_COMPLEX, 2, (0, 255, 0), 2
        )
